...
?>  
     ...
     <div class="box">
            <div class="box-list">
                ...
                <a href="index.php?xem=loaisp&id=28">
                    Xem thêm<span>...</span>
                </a>
            </div>
...
?>  
     ...
     <div class="box">
            <div class="box-list">
                <h3 align="center" class="title-box"><?php echo $dong_loaisp['tenloaisp']; ?></h3>
                <a href="index.php?xem=loaisp&id=29">
                    Xem thêm<span>...</span>
                </a>
            </div>
 		 ...
 		 <?php
        	...
        	<div class="item">
                    ...
                    <div class="subject">
                        <ul>
                            <li> <a href="index.php?xem=chitietsp&loaisp=<?php echo $dong['loaisp'] ?>&id=<?php echo $dong['ID_sp'] ?>" ></a>
                            </li>
